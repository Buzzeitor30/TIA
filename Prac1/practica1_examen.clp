...
(defrule leerconsola
	...
	(bind ?Rvel (read))
	(printout t"Introduzca la pendiente: "crlf)
	(bind ?Pend (read))
	...
	(bind ?edad (read))
	;Creamos los hechos
	(assert (vehiculo (id ?identificador) (distancia-crisp ?Rdist) (edad ?edad) (velocidad-crisp ?Rvel) (fuerza-de-aceleracion-crisp-momentum 0.0) (fuerza-de-aceleracion-crisp-maximum 0.0) (presion-freno-crisp-momentum 0.0) (presion-freno-crisp-maximum 0.0)))
	(fuzzify dis_rel ?Rdist 0.0)
	(fuzzify vel_rel ?Rvel 0.0)
	(fuzzify inclinacion ?Pend 0.0)
)

(defrule acercando_baja
	(vel_rel acercando)
	(inclinacion bajada)
	=>
...
(defrule emergencia
?c <- (vehiculo (id ?identificador) (distancia-crisp ?Rdist) (edad ?ed) (velocidad-crisp ?Rvel) (fuerza-de-aceleracion-crisp-momentum ?famo) (fuerza-de-aceleracion-crisp-maximum ?famax) (presion-freno-crisp-momentum ?pfmom) (presion-freno-crisp-maximum ?pfmax))
(test (> ?ed 15))
(fuerza_acel ?f)
(test (> (maximum-defuzzify ?f) 80))
=>
(printout t"Situación Crítica" crlf)
)
