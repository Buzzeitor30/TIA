...
:effect (and (at start (decrease (presupuesto) 20))
...
:duration (= ?duration 1)
:condition (and (at start (at ?p ?z1))
                (over all (at ?v ?z1))
        )
